...
function MDSnackbar({ color, loadingProgress, processingResult, title, content, close, bgWhite, ...rest }) {
      ...
      >
        ...
        >
          ...
          {loadingProgress !== undefined && (
            <MDTypography variant="body2" color={titleColor}>
...
MDSnackbar.propTypes = {
  ...
  processingResult: PropTypes.string,
